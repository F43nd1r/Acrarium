...
dependencies {
    ...
    implementation(springLibs.spring.springBootStarterCache)
    implementation(vaadinLibs.vaadin.vaadin)
    implementation(vaadinLibs.vaadin.vaadinSpringBootStarter)
    runtimeOnly(springLibs.mysql.mysqlConnectorJ)
    runtimeOnly(springLibs.mariadb.mariadbJavaClient)
    implementation(springLibs.liquibase.liquibaseCore)
    implementation(springLibs.spring.springBootLiquibase)
    ...
    implementation(springLibs.kotlinx.kotlinxCoroutinesCore)
    ...
    testImplementation(springLibs.spring.springBootWebmvcTest)
    testImplementation(springLibs.spring.springBootRestclientTest)
    testImplementation(springLibs.spring.springBootResttestclient)
    testImplementation(springLibs.spring.springBootTestcontainers)
    testImplementation(libs.spring.mockk)
    testImplementation(libs.strikt)
    testImplementation(springLibs.testcontainers.testcontainersMysql)
    testImplementation(springLibs.testcontainers.testcontainersMariadb)
    testImplementation(springLibs.testcontainers.testcontainersJunitJupiter)
